<script>
	...
	import {
		...
		FieldDescription,
		FieldSeparator,
	} from "$lib/components/ui-rtl/field/index.js";
...
<div class={cnRtl("flex flex-col gap-6", className)} bind:this={ref} {...restProps}>
	<form>
		<FieldGroup>
			<div class="flex flex-col items-center gap-2 text-center">
				...
				<h1 class="text-xl font-bold">خوش آمدید به شرکت آکمی</h1>
				<FieldDescription>
					حساب کاربری ندارید؟ <a href="##">ثبت‌نام کنید</a>
				</FieldDescription>
			</div>
			<Field>
				<FieldLabel for="email-{id}">ایمیل</FieldLabel>
				<Input id="email-{id}" type="email" placeholder="example@email.com" required />
			</Field>
			<Field>
	...
	<FieldDescription class="px-6 text-center">
		با کلیک بر روی ادامه، شما با <a href="##">شرایط استفاده</a> و
